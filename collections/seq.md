...
```scala
Queue(1, 2, 3)
// res37: scala.collection.immutable.Queue[Int] = Queue(1, 2, 3)
```
...
// res49: scala.collection.immutable.Seq[String] = List(mouse, cat, dog, penguin, tyrannosaurus)
```
</div>
